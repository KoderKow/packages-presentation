...
- When we write our functions we may use other libraries functions
  - Such as the pipe, `%>%`, from magrittr
- If we want to use these "outsider" functions within our package we will need to tell our package to **import** these libraries and functions
