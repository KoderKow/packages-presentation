...
- As the command states, this is only the skeleton. We will need to fill in the rest manually
]
.pull-right[
...
- If you have are familiar with packages on GitHub this may look familiar: <img src="https://i.imgur.com/jrOk8iP.png" width="9%"/>
- `build: passing`, what does this mean?
  ...
  - Travis CI (Continuous Integration) is essentially doing a `check()` for us every commit and making sure it can be successfully installed on others machines
    - If your package is not private and open source then Travis CI will be free for you
...
- You will land on a page with "GitHub Apps Integration" on it
  - Hit the "Activate" button
- You will be taken to GitHub to approve Travis CI with your repos
